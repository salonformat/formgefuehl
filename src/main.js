...
app.innerHTML = `
  ...
  <main>
    ...
    <section id="compose" class="screen compose" aria-labelledby="compose-title" hidden>
      ...
      <p class="learning" id="repeat-learning">Ein Zeichen wird zum <em>Rapport</em> – der Einheit, die sich wiederholt. Aus solchen Wiederholungen entstehen zum Beispiel Stoff- und Tapetenmuster.</p>
      ...
      <button class="primary" id="enter">Das Muster betreten ${arrow}</button>
      <p id="empty-hint" class="quiet" hidden>Setze zuerst mindestens ein Zeichen.</p></div>
