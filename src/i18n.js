...
const pairs = [
 ...
 ['In Wien entstand 1903 eine Gemeinschaft von Künstler:innen und Handwerker:innen. Sie gestalteten Möbel, Stoffe, Geschirr und ganze Räume. Die aufwendig gefertigten Stücke waren meist nur für Wohlhabende erschwinglich.','In Vienna in 1903, artists and craftspeople came together. They designed furniture, fabrics, tableware and entire rooms. Their carefully handcrafted pieces were mostly affordable only to wealthy buyers.'],
 ...
 ['Ein unabhängiges Projekt von Salon Format, entstanden ohne Zusammenarbeit mit einem Museum.','An independent project by Salon Format, created without collaboration with any museum.'],
 ...
 ['Formgefühl ist ein unabhängiges Projekt von Salon Format, entstanden ohne Zusammenarbeit mit einem Museum. Alle Muster, Räume und Klänge wurden eigens dafür entwickelt.','A Feel for Form is an independent project by Salon Format, created without collaboration with any museum. All patterns, spaces and sounds were developed especially for it.'],
