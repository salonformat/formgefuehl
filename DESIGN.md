...
## Pattern-to-room choreography
The existing pattern sheet separates into six UV-continuous strips that unfold into the hanging room panels over 2.7 seconds. The patterned floor pivots down; structural frames and the central relief arrive later. Native Back reverses the scene. Reduced motion bypasses the build and disables the editing bounce, breeze and light sweep. Paper curls, cloth pleats with woven bump and sheen, and metal uses anisotropic highlights under a moving directional light. Coarse-pointer devices use a lower rendering pixel ratio.
The desktop editor now places colour and editing tools beside the larger grid. A cell press responds locally and sends a restrained pulse through the actual pattern preview. Mobile keeps the bounded scrolling editor and its persistent action.
